...
<div class="login_area">
	...
	<div class="login_list">
		<ul class="clear">
			<li class="icon_id"><span>ID</span><input type="text" placeholder="id" name="mb_id"class="serach"></li>
			<li class="icon_pw"><span>PW</span><input type="password" placeholder="password" name="mb_pw"class="search"></li>
		</ul>
		<div class="login_btn">
